class House:
    ...
    def __add__(self, value): #Обычное сложение целых чисел
    ...
    def go_to(self, new_floor):
        if (new_floor > 0 and self.number_of_floors > 0 and
                isinstance(new_floor, int) and isinstance(self.number_of_floors, int)):
